...
public class ParagraphPortionTests : SCTest
{
    ...
    public void Text_Getter_returns_text_of_paragraph_portion()
    {
        ...
        IParagraphPortion portion = ((ITable)pres.SlideCollection[2].ShapeCollection.First(sp => sp.Id == 3)).Rows[0].Cells[0]
            .TextBox
    ...
    public void Hyperlink_Setter_sets_hyperlink(string pptxFile, string shapeName)
    {
        ...
        var autoShape = presentation.SlideCollection[0].ShapeCollection.GetByName<IShape>(shapeName);
        var portion = autoShape.TextBox.Paragraphs[0].Portions[0];
        ...
        autoShape = presentation.SlideCollection[0].ShapeCollection.GetByName<IShape>(shapeName);
    ...
    public void Hyperlink_Setter_sets_hyperlink_for_two_shape_on_the_Same_slide()
    {
        ...
        var presentation = new Presentation(pptxStream);
        var textBox3 = presentation.SlideCollection[0].ShapeCollection.GetByName<IShape>("TextBox 3");
        var textBox4 = presentation.SlideCollection[0].ShapeCollection.GetByName<IShape>("TextBox 4");
    ...
    public void TextHighlightColor_Getter_returns_text_highlight_color()
    {
        ...
        var pres = new Presentation(pptx);
        var shape = pres.SlideCollection[0].ShapeCollection.GetByName<IShape>("TextBox 3");
        var portion = shape.TextBox!.Paragraphs[0].Portions[0];
    ...
    public void TextHighlightColor_Setter_sets_text_highlight_color()
    {
        ...
        var pptx = TestAsset("autoshape-grouping.pptx");
        var pres = new Presentation(pptx);
        var shape = pres.SlideCollection[0].ShapeCollection.GetByName<IShape>("TextBox 4");
        var portion = shape.TextBox!.Paragraphs[0].Portions[0];
