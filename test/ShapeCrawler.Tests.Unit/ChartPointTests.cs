...
public class ChartPointTests : SCTest
{
    ...
    public void Value_Getter_returns_point_value_of_Bar_chart()
    {
        ...
        var shapes1 = pres21.SlideCollection[0].ShapeCollection;
        var chart1 = (IChart)shapes1.First(x => x.Id == 3);
        ISeries chart6Series = ((IChart)pres25.SlideCollection[1].ShapeCollection.First(sp => sp.Id == 4)).SeriesList[0];
    ...
    public void Value_Getter_returns_point_value_of_Scatter_chart()
    {
        ...
        var shapes1 = pres.SlideCollection[0].ShapeCollection;
        var chart1 = (IChart)shapes1.First(x => x.Id == 3);
    ...
    public void Value_Getter_returns_chart_point()
    {
        ...
        var seriesCase1 = pres21.SlideCollection[1].ShapeCollection.GetById<IChart>(3).SeriesList[0];
        var seriesCase2 = pres21.SlideCollection[2].ShapeCollection.GetById<IChart>(4).SeriesList[0];
        var seriesCase3 = pres009.SlideCollection[2].ShapeCollection.GetById<IChart>(7).SeriesList[0];
    ...
    public void Value_Setter_updates_chart_point_in_Embedded_excel_workbook()
    {
        ...
        var chart = pres.SlideCollection[2].ShapeCollection.GetById<IChart>(5);
    ...
    public void Value_Getter_returns_chart_point2()
    {
        ...
        var chart1 = pres.SlideCollection[0].ShapeCollection.First() as IChart;
        ...
        var chart2 = pres.SlideCollection[1].ShapeCollection.First() as IChart;
        ...
        var chart3 = pres.SlideCollection[2].ShapeCollection.First() as IChart;
    ...
    public void Value_Setter_updates_chart_point(string file, int slideNumber, string shapeName)
    {
        ...
        var chart = pres.SlideCollection[--slideNumber].ShapeCollection.GetByName<IChart>(shapeName);
        var point = chart.SeriesList[0].Points[0];
        ...
        chart = pres.SlideCollection[slideNumber].ShapeCollection.GetByName<IChart>(shapeName);
