...
public class ChartTests : SCTest
{
    ...
    public void TitleAndHasTitle_ReturnChartTitleStringAndFlagIndicatingWhetherChartHasATitle()
    {
        ...
        IChart chartCase7 = (IChart)SCPresentation.Open(TestHelperShared.GetStream("009_table.pptx")).Slides[2].Shapes.First(sp => sp.Id == 7);
        IChart chartCase8 = (IChart)SCPresentation.Open(TestHelperShared.GetStream("009_table.pptx")).Slides[2].Shapes.First(sp => sp.Id == 6);
        IChart chartCase9 = (IChart)SCPresentation.Open(TestHelperShared.GetStream("009_table.pptx")).Slides[4].Shapes.First(sp => sp.Id == 6);
        IChart chartCase10 = (IChart)SCPresentation.Open(TestHelperShared.GetStream("009_table.pptx")).Slides[4].Shapes.First(sp => sp.Id == 3);
        IChart chartCase11 = (IChart)SCPresentation.Open(TestHelperShared.GetStream("009_table.pptx")).Slides[4].Shapes.First(sp => sp.Id == 5);
    ...
    public static IEnumerable<object[]> TestCasesSeriesCollectionCount()
    {
        ...
        pptxStream = TestHelperShared.GetStream("009_table.pptx");
    ...
    public void CategoryName_GetterReturnsChartCategoryName()
    {
        ...
        IPieChart chartCase3 = (IPieChart)SCPresentation.Open(TestHelperShared.GetStream("009_table.pptx")).Slides[2].Shapes.First(sp => sp.Id == 7);
    ...
    public void Type_ReturnsChartType()
    {
        ...
        IChart chartCase3 = (IChart)pres13.Slides[0].Shapes.First(sp => sp.Id == 5);
        IChart chartCase4 = (IChart)SCPresentation.Open(TestHelperShared.GetStream("009_table.pptx")).Slides[2].Shapes.First(sp => sp.Id == 7);
    ...
    [Test]
    public void Axes_HorizontalAxis_Minimum_Getter()
    {
        // Arrange
        ...
        // Act
        var minimum = barChart.Axes.HorizontalAxis.Minimum;
    ...
    [Test]
    public void Axes_HorizontalAxis_Maximum_Getter_returns_default_6()
    {
        // Arrange
        var pptx = TestHelper.GetStream("charts_bar-chart.pptx");
        var pres = SCPresentation.Open(pptx);
        ...
        // Act
        var maximum = barChart.Axes.HorizontalAxis.Maximum;
