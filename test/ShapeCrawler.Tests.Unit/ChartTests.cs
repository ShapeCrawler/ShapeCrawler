...
public class ChartTests : SCTest
{
    ...
    {
        // Arrange
        IChart chart = (IChart)new SCPresentation(GetInputStream("021.pptx")).Slides[2].Shapes.First(sp => sp.Id == 4);
    ...
    {
        // Arrange
        var pres13 = new SCPresentation(GetInputStream("013.pptx"));
        var pres19 = new SCPresentation(GetInputStream("019.pptx"));
        IChart chartCase1 = (IChart)new SCPresentation(GetInputStream("018.pptx")).Slides[0].Shapes.First(sp => sp.Id == 6);
        IChart chartCase2 = (IChart)new SCPresentation(GetInputStream("025_chart.pptx")).Slides[0].Shapes.First(sp => sp.Id == 7);
        ...
        IChart chartCase7 = (IChart)new SCPresentation(GetInputStream("009_table.pptx")).Slides[2].Shapes.First(sp => sp.Id == 7);
        IChart chartCase8 = (IChart)new SCPresentation(GetInputStream("009_table.pptx")).Slides[2].Shapes.First(sp => sp.Id == 6);
        IChart chartCase9 = (IChart)new SCPresentation(GetInputStream("009_table.pptx")).Slides[4].Shapes.First(sp => sp.Id == 6);
        IChart chartCase10 = (IChart)new SCPresentation(GetInputStream("009_table.pptx")).Slides[4].Shapes.First(sp => sp.Id == 3);
        IChart chartCase11 = (IChart)new SCPresentation(GetInputStream("009_table.pptx")).Slides[4].Shapes.First(sp => sp.Id == 5);
    ...
    {
        // Arrange
        IBarChart chartCase1 = (IBarChart)new SCPresentation(GetInputStream("025_chart.pptx")).Slides[0].Shapes.First(sp => sp.Id == 4);
        IPieChart chartCase3 = (IPieChart)new SCPresentation(GetInputStream("009_table.pptx")).Slides[2].Shapes.First(sp => sp.Id == 7);
    ...
    {
        // Arrange
        var comboChart = (IComboChart)new SCPresentation(GetInputStream("021.pptx")).Slides[0].Shapes.First(sp => sp.Id == 4);
    ...
    {
        // Arrange
        var chartCase1 = (IBarChart)new SCPresentation(GetInputStream("025_chart.pptx")).Slides[0].Shapes.First(sp => sp.Id == 4);
    ...
    {
        // Arrange
        var pres = new SCPresentation(GetInputStream("025_chart.pptx"));
    ...
    {
        // Arrange
        IChart chart = (IChart)new SCPresentation(GetInputStream("021.pptx")).Slides[0].Shapes.First(sp => sp.Id == 3);
    ...
    {
        // Arrange
        IChart chart = (IChart)new SCPresentation(GetInputStream("025_chart.pptx")).Slides[0].Shapes.First(sp => sp.Id == 5);
    ...
    public void Type_ReturnsChartType()
    {
        // Arrange
        var pres13 = new SCPresentation(GetInputStream("013.pptx"));
        IChart chartCase1 = (IChart)new SCPresentation(GetInputStream("021.pptx")).Slides[1].Shapes.First(sp => sp.Id == 3);
        IChart chartCase2 = (IChart)new SCPresentation(GetInputStream("021.pptx")).Slides[2].Shapes.First(sp => sp.Id == 4);
        IChart chartCase3 = (IChart)pres13.Slides[0].Shapes.First(sp => sp.Id == 5);
        IChart chartCase4 = (IChart)new SCPresentation(GetInputStream("009_table.pptx")).Slides[2].Shapes.First(sp => sp.Id == 7);
    ...
    {
        // Arrange
        IChart chart = (IChart)new SCPresentation(GetInputStream("018.pptx")).Slides[0].Shapes.First(sp => sp.Id == 6);
