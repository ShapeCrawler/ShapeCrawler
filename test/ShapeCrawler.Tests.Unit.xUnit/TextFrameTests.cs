...
using ShapeCrawler.Tests.Unit.xUnit.Helpers;
using ShapeCrawler.Tests.Unit.xUnit.Helpers.Attributes;
using Xunit;
    ...
    public class TextFrameTests : SCTest
    {
        ...
        public static TheoryData<TestElementQuery> TestCasesTextSetter
        {
            get
            {
                ...
                {
                    Presentation = SCPresentation.Open(GetInputStream("001.pptx")),
                    SlideIndex = 0,
                    ShapeId = 3
                };
                testCases.Add(case1);
                ...
                {
                    Presentation = SCPresentation.Open(GetInputStream("020.pptx")),
                    SlideIndex = 2,
                    ShapeId = 8
                };
                testCases.Add(case2);
                ...
                {
                    Presentation = SCPresentation.Open(GetInputStream("autoshape-case004_subtitle.pptx")),
                    SlideNumber = 1,
                ...
                {
                    Presentation = SCPresentation.Open(GetInputStream("autoshape-case008_text-frame.pptx")),
                    SlideNumber = 1,
