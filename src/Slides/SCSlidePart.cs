...
internal readonly ref struct SCSlidePart(SlidePart slidePart)
{
        ...
        string seriesName)
    {
        ...
        var xNumberLiteral = new NumberLiteral(new FormatCode("General"), new PointCount { Val = pointsCount });
        ...
        var yNumberLiteral = new NumberLiteral(new FormatCode("General"), new PointCount { Val = pointsCount });
