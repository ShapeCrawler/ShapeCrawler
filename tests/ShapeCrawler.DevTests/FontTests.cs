...
public class FontTests : SCTest
{
    ...
    public void EastAsianName_Setter_sets_font_for_the_east_asian_characters_1()
    {
        ...
        var font = pres.Slide(1).Shapes.Last().ShapeText!.Paragraphs[0].Portions[0].Font!;
    ...
    public void Size_Getter_returns_font_size_of_non_first_portion()
    {
        ...
        var font1 = pres1.Slide(1).Shapes.GetById<IShape>(5).ShapeText!.Paragraphs[0].Portions[2].Font!;
        var pres2 = new Presentation(TestAsset("009_table.pptx"));
        var font2 = pres2.Slide(3).Shapes.GetById<IShape>(2).ShapeText!.Paragraphs[0].Portions[1].Font!;
    ...
    public void Size_Getter_returns_font_size_of_Non_Placeholder_Table()
    {
        ...
        var portion = table.Table.Rows[0].Cells[0].ShapeText.Paragraphs[0].Portions[0];
    ...
    public void IsBold_GetterReturnsTrue_WhenFontOfNonPlaceholderTextIsBold()
    {
        ...
        var font = nonPlaceholder.ShapeText!.Paragraphs[0].Portions[0].Font!;
    ...
    public void IsBold_GetterReturnsTrue_WhenFontOfPlaceholderTextIsBold()
    {
        ...
        var font = placeholder.ShapeText!.Paragraphs[0].Portions[0].Font!;
    ...
    public void IsBold_Setter_AddsBoldForNonPlaceholderTextFont()
    {
        ...
        var pres = new Presentation(TestAsset("020.pptx"));
        var font = pres.Slide(1).Shapes.GetById(2).ShapeText!.Paragraphs[0].Portions[0].Font!;
        ...
        font = pres.Slide(1).Shapes.GetById(2).ShapeText!.Paragraphs[0].Portions[0].Font!;
        font.IsBold.Should().BeTrue();
    }
    ...
    public void IsItalic_Setter_SetsItalicFontForForNonPlaceholderText()
    {
        ...
        font = nonPlaceholder.ShapeText!.Paragraphs[0].Portions[0].Font!;
        font.IsItalic.Should().BeTrue();
    }
    ...
    public void IsItalic_SetterSetsNonItalicFontForPlaceholderText_WhenFalseValueIsPassed()
    {
        ...
        font = placeholder.ShapeText!.Paragraphs[0].Portions[0].Font!;
        font.IsItalic.Should().BeFalse();
    }
    ...
    public void LatinName_Setter_sets_font_for_the_latin_characters_of_table_cell()
    {
        ...
        var cell = table[1, 2];
        cell.ShapeText.SetText("Test");
        var font = cell.ShapeText.Paragraphs.First().Portions.First().Font!;
    ...
    public void LatinName_Setter_sets_font_for_the_latin_characters()
    {
        ...
        shape1.ShapeText!.Paragraphs[0].Portions[0].Font!.LatinName = "Segoe UI Semibold";

        // Act
        shape2.ShapeText!.SetText("Shape 2");
        shape2.ShapeText!.Paragraphs[0].Portions[0].Font!.LatinName = "Aptos";

        // Assert
        shape1.ShapeText!.Paragraphs[0].Portions[0].Font.LatinName.Should().Be("Segoe UI Semibold");
    }
    ...
    public void Size_Setter_sets_font_size(string presentation, int slideNumber, string shapeName)
    {
        ...
        var font = pres.Slide(slideNumber).Shape(shapeName).ShapeText!.Paragraphs[0].Portions[0].Font!;
        var mStream = new MemoryStream();
        ...
        pres.Save(mStream);
        pres = new Presentation(mStream);
        font = pres.Slide(slideNumber).Shape(shapeName).ShapeText!.Paragraphs[0].Portions[0].Font!;
    ...
    public void OffsetEffect_Getter_returns_offset_of_Text(string presentation, int slideNumber, string shapeName, int expectedOffset)
    {
        ...
        var font = shape.ShapeText!.Paragraphs[0].Portions[1].Font!;
    ...
    public void LatinName_Setter()
    {
        ...
        var font = addedShape.ShapeText!.Paragraphs[0].Portions[0].Font!;
        ...
        // Assert
        pres.Save(stream);
        font = new Presentation(stream).Slide(1).Shapes.Last().ShapeText!.Paragraphs[0].Portions[0].Font!;
